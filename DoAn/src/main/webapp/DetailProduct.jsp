      ...
      <section class="mb-5">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <p><span class="mr-1"><strong>${detail.price }VNĐ</strong></span><span
                    class="text-grey"><strong><s>${String.format("%.0f",detail.price*1.1) }VNĐ</s></strong></span></p>
      ...
      <div class="classic-tabs">
        ...
        <div class="tab-content" id="advancedTabContent">
          <div class="tab-pane fade show active" id="description" role="tabpanel" aria-labelledby="description-tab">
            ...
            <h6>${String.format(detail.price*0.9) }VNĐ</h6>
            <p class="pt-1">${detail.description}</p>
          </div>
          ...
          <div class="col-md-6 col-lg-3 mb-5">
            ...
            <div class="">
              ...
              <div class="pt-4">
                ...
                <h5>${o.title }</h5>
                <p><span class="text-danger mr-1"><strong>${o.price }VNĐ</strong></span><span
                    class="text-grey"><strong><s>${String.format("%.0f",o.price*1.1) }VNĐ</s></strong></span></p>
