...
<body class="skin-light" onload="loadAmountCart()">
            ...
            <section>
              ...
              <section class="mb-4">
                ...
                <div class="form-check pl-0 mb-3">
                  <input onchange="searchByPriceUnder2000k()" type="radio" class="form-check-input" id="under100" name="materialExampleRadios">
                  <label class="form-check-label small text-uppercase card-link-secondary" for="under100">Under
                    2000k VNĐ</label>
                </div>
                <div class="form-check pl-0 mb-3">
                  <input onchange="searchByPrice2000kTo5000k()" type="radio" class="form-check-input" id="100200" name="materialExampleRadios">
                  <label class="form-check-label small text-uppercase card-link-secondary" for="100200">2000k to
                    5000k VNĐ</label>
                </div>
                <div class="form-check pl-0 mb-3">
                  <input onchange="searchByPriceAbove5000k()" type="radio" class="form-check-input" id="200above" name="materialExampleRadios">
                  <label class="form-check-label small text-uppercase card-link-secondary" for="200above">5000k VNĐ &
                    Above</label>
                </div>
                <form>
  ...
  <script>
    ...
    function searchByPriceMinToMax(){
        ...
        $.ajax({
            url: "/DoAn/searchAjaxPriceMinToMax",
            type: "get", //send it through get method
            data: {
                priceMin: numMin,
                priceMax: numMax
    ...
    function searchByPriceUnder2000k(){
        $.ajax({
            url: "/DoAn/searchAjaxPriceUnder2000k",
            type: "get", //send it through get method
            data: {
    ...
    function searchByPrice2000kTo5000k(){
        $.ajax({
            url: "/DoAn/searchAjaxPrice2000kTo5000k",
            type: "get", //send it through get method
            data: {
    ...
    function searchByPriceAbove5000k(){
        $.ajax({
            url: "/DoAn/searchAjaxPriceAbove5000k",
            type: "get", //send it through get method
            data: {
