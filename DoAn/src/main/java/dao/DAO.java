...
public class DAO {
        ...
        try {
            ...
            while (rs.next()) {
                list.add(new TongChiTieuBanHang(rs.getInt(1),
                        rs.getDouble(2),
                        decimalFormat.format(rs.getDouble(3))
                       ));
            }
        } catch (Exception e) {
        }
    ...
    public List<Product> getNext4TQAProduct(int amount) {
        List<Product> list = new ArrayList<>();
        String query = "select * from Product\r\n"
        		+ "where cateID=1\r\n"
        		+ "order by id desc\r\n"
    ...
    public List<Product> getNext4BPNProduct(int amount) {
        List<Product> list = new ArrayList<>();
        String query = "select * from Product\r\n"
        		+ "where cateID=5\r\n"
        		+ "order by id desc\r\n"
...
//            ps.setString(1,ngayXuat);
    ...
    public List<Product> searchPriceUnder2000k() {
        List<Product> list = new ArrayList<>();
        String query = "select * from Product\r\n"
        		+ "where [price] < 2000000";
        try {
    ...
    public List<Product> searchPrice2000kTo5000k() {
        List<Product> list = new ArrayList<>();
        String query = "select * from Product\r\n"
    ...
    public List<Product> searchPriceAbove5000k() {
        List<Product> list = new ArrayList<>();
        String query = "select * from Product\r\n"
        		+ "where [price] > 5000000";
        try {
...
//
    ...
    public List<Product> get4TQALast() {
    	List<Product> list = new ArrayList<>();
        String query = "select top 4 * from Product\r\n"
        		+ "where cateID = 1\r\n"
        		+ "order by id desc";
    ...
    public List<Product> get4BPNLast() {
    	List<Product> list = new ArrayList<>();
        String query = "select top 4 * from Product\r\n"
        		+ "where cateID = 5\r\n"
        		+ "order by id desc";
    ...
    public void insertProduct(String name, String image, String price,
            String title, String description, String category, int sid, String model, String image2, String image3, String image4) {
        String query = "insert Product([name],[image],[price],[title],\r\n"
        		+ "[description],[cateID],[sell_ID],[model],\r\n"
        		+ "[image2],[image3],[image4])\r\n"
        		+ "values(N'"+name+"','"+image+"','"+price+"',N'"+title+"',N'"+description+"','"+category+"','"+sid+"',N'"+model+"','"+image2+"','"+image3+"','"+image4+"')";
        try {
    ...
    public void editProduct(String pname, String pimage, String pprice, String ptitle, String pdescription, String pcategory, 
    		String pmodel, String pimage2, String pimage3, String pimage4, String pid) {
