...
@WebServlet(name = "LoadMoreBPNControl", urlPatterns = {"/loadBPN"})
public class LoadMoreBPNControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String amount = request.getParameter("exitsBPN");
        int iamount = Integer.parseInt(amount);
        DAO dao = new DAO();
        List<Product> list = dao.getNext4BPNProduct(iamount);
